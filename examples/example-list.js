let examples = [
        ...
        child: [
            {
                ...
                child: [
                    ...
                    { target: "rigids::st_st_link2", zh: "双球环扣", en: "2 STs Link" },
                    { target: "rigids::st_st_link4", zh: "四球环扣", en: "4 STs Link" },
                    // { target: "rigids::st_st_link6", zh: "六球环扣", en: "6 STs Link" },
                ]
            },
            {
            ...
            {
                group: "n-body", zh: "N体问题", en: "N-body Problems",
                child: [
                    { target: "rigids::gravity2", zh: "平方反比律", en: "Inverse Square Law" },
                    { target: "rigids::gravity3", zh: "立方反比律", en: "Inverse Cubic Law" },
                    { target: "rigids::gravity3s", zh: "修正立方反比律", en: "Modified Inverse Cubic Law" },
                    { target: "rigids::gravityRing", zh: "球环天体", en: "Spheritoridal Body" },
                ]
            },
    ...
    },
    {
        ...
        child: [
            ...
            { target: "vsepr", zh: "价电子互斥模型", en: "VSEPR Model" },
            { target: "vsepr::hyperdiamond", zh: "超金刚石", en: "Hyperdiamond" },
...
let info = {
    ...
    "pde::erosion": {
        "zh": "通过降雨模拟四维世界中的地形侵蚀与河流演化。地形由三维单形分形噪声生成。",
        "en": "River evolution simulated by rain fall and and terrain erosion. Terrain is generated by fractal 3d simplex noise."
    },
    "rigids::e_charge": {
    ...
    "hh": {
        ...
        "en": "<b>Control: Trackball mode</b><br>Harmonic functions on S3. Detail can be found <a href='https://wxyhly-en.github.io/archives/hh/' target='_blank'>here</a>. Please choose wave functions by multi-level selection menu, the last level is green button (Cyan after click). Use mouse wheel to push/pull camera to move in/out of the hypersphere.",
    },
    "molecule": {
    ...
    "shapes::suzanne3d": {
        "zh": "<b>控制：轨迹球模式</b><br>将blender中默认自带的三维猴头“suzanne”模型生成的四维旋转体。",
        "en": "<b>Control: Trackball mode</b><br>4D solid of revolution with the default 3D monkey head \"suzanne\" model in blender as the generatrix."
    },
    "rigids::thermo_stats": {
        "zh": "<b>控制：保持竖直模式</b><br>四维热力学玩具模型。探究随机碰撞的小球的轨道角动量、自旋角动量的分布。对偶性越大越接近左等角双旋转，越小越接近右等角双旋转，0为简单旋转。",
        "en": "<b>Control: Keep up mode</b><br>4D thermodynamics toy model. This is for studying the distribution of orbital and spin angular momentum of random collision glomes. The more duality, the closer to left isoclinic rotation. The less duality, the closer to right isoclinic rotation. 0 for simple rotation."
    },
    "rigids::gravity2": {
        "zh": "<b>控制：轨迹球模式</b><br>平方反比引力下的四维天体模拟。然而这并不是四维世界“真实”的情形。",
        "en": "<b>Control: Trackball mode</b><br>4D celestial simulation under inverse-square law gravity. However, this is not the 'real' situation in 4D world."
    },
    "rigids::gravity3": {
        "zh": "<b>控制：轨迹球模式</b><br>立方反比引力下的四维天体模拟，可见星体要么互相远离要么互相融合，不存在持续稳定的轨道。",
        "en": "<b>Control: Trackball mode</b><br>4D celestial simulation under inverse-cubic law gravity. It can be seen that celestial bodies either move away from each other or merge together, and there are no stable orbits."
    },
    "rigids::gravity3s": {
        "zh": "<b>控制：轨迹球模式</b><br>立方反比引力下加入了短程斥力的四维天体模拟。通过引入带质量的玻色子可产生指数衰减（精确解含第二类修正贝塞尔函数）的短程相互作用。该模型可以解决四维原子的稳定性，然而用于四维天体，短程斥力将导致无法形成聚集的星体，整个宇宙将只有一些孤立的超低密度气体星团。",
