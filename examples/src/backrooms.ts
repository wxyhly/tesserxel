...
export namespace backrooms {
    ...
    class MapGenerator {
        ...
        private genPillar() {
            ...
            let wall = mesh.tetra.inverseNormal(mesh.tetra.applyObj4(
                mesh.tetra.clone(tesseract),
            ...
            let zw = mesh.tetra.applyObj4(mesh.tetra.clone(tesseract), new math.Obj4(new math.Vec4(), new math.Rotor(), new math.Vec4(
                this.pillarSize1,
                1,
                this.pillarSize2,
                this.pillarSize2
            )));
            let xw = mesh.tetra.applyObj4(mesh.tetra.clone(tesseract), new math.Obj4(new math.Vec4(), new math.Rotor(), new math.Vec4(
                this.pillarSize2,
                1,
                this.pillarSize1,
                this.pillarSize2
            )));
            let xz = mesh.tetra.applyObj4(mesh.tetra.clone(tesseract), new math.Obj4(new math.Vec4(), new math.Rotor(), new math.Vec4(
                this.pillarSize2,
                1,
                this.pillarSize2,
                this.pillarSize1
