...
declare class Vec4 {
    ...
    z: number;
    w: number;
    static readonly x: Readonly<Vec4>;
    static readonly y: Readonly<Vec4>;
    static readonly z: Readonly<Vec4>;
    static readonly w: Readonly<Vec4>;
    static readonly origin: Readonly<Vec4>;
    static readonly xNeg: Readonly<Vec4>;
    static readonly yNeg: Readonly<Vec4>;
    static readonly zNeg: Readonly<Vec4>;
    static readonly wNeg: Readonly<Vec4>;
    constructor(x?: number, y?: number, z?: number, w?: number);
    flat(): number[];
    writeBuffer(b: Float32Array, offset?: number): void;
...
interface OrthographicCamera$1 {
    /** size = height */
    size: number;
    near: number;
    far: number;
...
declare function getPerspectiveProjectionMatrix(c: PerspectiveCamera$1): {
    /** used for 3d */
    mat4: Mat4;
    /** used for 4d because of lack of mat5x5 */
    vec4: Vec4;
};
declare function getOrthographicProjectionMatrix(c: OrthographicCamera$1): {
    /** used for 3d */
    mat4: Mat4;
    /** used for 4d because of lack of mat5x5
     */
...
declare namespace math_d {
  export { math_d_AABB as AABB, math_d_AffineMat4 as AffineMat4, math_d_Bivec as Bivec, math_d_BivecPool as BivecPool, math_d_Complex as Complex, math_d_CosetTable as CosetTable, math_d_Mat2 as Mat2, math_d_Mat2Pool as Mat2Pool, math_d_Mat3 as Mat3, math_d_Mat3Pool as Mat3Pool, math_d_Mat4 as Mat4, math_d_Mat4Pool as Mat4Pool, math_d_Obj4 as Obj4, math_d_Perlin3 as Perlin3, math_d_Plane as Plane, math_d_Polytope as Polytope, math_d_Quaternion as Quaternion, math_d_Ray as Ray, math_d_Rotor as Rotor, math_d_Spline as Spline, math_d_Srand as Srand, math_d_Vec2 as Vec2, math_d_Vec2Pool as Vec2Pool, math_d_Vec3 as Vec3, math_d_Vec3Pool as Vec3Pool, math_d_Vec4 as Vec4, math_d_Vec4Pool as Vec4Pool, math_d__120 as _120, math_d__180 as _180, math_d__30 as _30, math_d__360 as _360, math_d__45 as _45, math_d__60 as _60, math_d__90 as _90, math_d__COS30 as _COS30, math_d__DEG2RAD as _DEG2RAD, math_d__GOLDRATIO as _GOLDRATIO, math_d__RAD2DEG as _RAD2DEG, math_d__SQRT_3 as _SQRT_3, math_d__TAN30 as _TAN30, math_d_bivecPool as bivecPool, math_d_generateUUID as generateUUID, math_d_getOrthographicProjectionMatrix as getOrthographicProjectionMatrix, math_d_getPerspectiveProjectionMatrix as getPerspectiveProjectionMatrix, math_d_mat2Pool as mat2Pool, math_d_mat3Pool as mat3Pool, math_d_mat4Pool as mat4Pool, math_d_vec2Pool as vec2Pool, math_d_vec3Pool as vec3Pool, math_d_vec4Pool as vec4Pool };
  export type { OrthographicCamera$1 as OrthographicCamera, PerspectiveCamera$1 as PerspectiveCamera };
}
...
declare class SliceRenderer {
    ...
    getDisplayConfig(configNames: 'camera3D' | 'camera4D'): PerspectiveCamera$1 | OrthographicCamera$1;
...
declare class RetinaSliceBufferMgr {
    ...
    setRetinaProjectMatrix(camera: PerspectiveCamera$1 | OrthographicCamera$1): void;
    setRetinaViewMatrix(m: Mat4): void;
    getRetinaCamera(): PerspectiveCamera$1 | OrthographicCamera$1;
    setCameraProjectMatrix(camera: PerspectiveCamera$1 | OrthographicCamera$1): void;
...
interface DisplayConfig {
    ...
    camera4D?: PerspectiveCamera$1 | OrthographicCamera$1;
    /** camera3D is for rendering 3d retina */
    camera3D?: PerspectiveCamera$1 | OrthographicCamera$1;
...
type DisplayConfigName = keyof DisplayConfig;
...
type SlicePipelineLayout = GPUAutoLayoutMode | {
...
declare namespace face_d {
  export { face_d_FaceIndexMesh as FaceIndexMesh, face_d_FaceMesh as FaceMesh, face_d_circle as circle, cube$1 as cube, face_d_findBorder as findBorder, parametricSurface$1 as parametricSurface, face_d_polygon as polygon, sphere$1 as sphere, face_d_square as square };
  export type { face_d_FaceIndexMeshData as FaceIndexMeshData, face_d_FaceMeshData as FaceMeshData };
}

type FaceId = number;
type Simplex = number[];
type Face = Array<FaceId>;
type FaceOrientaion = Array<boolean>;
type DimList<T> = Array<T>;
type CWMeshStructData = DimList<Face[] | Vec4[]>;
type OrientaionData = DimList<FaceOrientaion[]>;
type CWMeshSelectionData = DimList<Set<FaceId>>;
type RankedCWMap = DimList<Map<FaceId, FaceId>>;
...
declare namespace tetra_d {
  export { tetra_d_TetraIndexMesh as TetraIndexMesh, tetra_d_TetraMesh as TetraMesh, tetra_d_concat as concat, tetra_d_convexhull as convexhull, tetra_d_cube as cube, tetra_d_cwmesh as cwmesh, tetra_d_directProduct as directProduct, tetra_d_ditorus as ditorus, tetra_d_duocylinder as duocylinder, tetra_d_glome as glome, tetra_d_hexadecachoron as hexadecachoron, tetra_d_loft as loft, tetra_d_parametricSurface as parametricSurface, tetra_d_rotatoid as rotatoid, tetra_d_sphere as sphere, tetra_d_spherinderSide as spherinderSide, tetra_d_spheritorus as spheritorus, tetra_d_tesseract as tesseract, tetra_d_tiger as tiger, tetra_d_torisphere as torisphere };
  export type { tetra_d_TetraIndexMeshData as TetraIndexMeshData, tetra_d_TetraMeshData as TetraMeshData };
}
...
type Color = GPUColor | ColorOutputNode;
type Float = number | FloatOutputNode;
...
declare class ColorMixer extends MaterialNode {
    output: "color";
    input: {
        color1: ColorOutputNode;
        color2: ColorOutputNode;
...
declare namespace mesh_d {
  export { mesh_d_CWMesh as CWMesh, mesh_d_CWMeshSelection as CWMeshSelection, mesh_d_FaceIndexMesh as FaceIndexMesh, mesh_d_FaceMesh as FaceMesh, mesh_d_ObjFile as ObjFile, mesh_d_TetraIndexMesh as TetraIndexMesh, mesh_d_TetraMesh as TetraMesh, geoms_d as cw, face_d as face, tetra_d as tetra };
  export type { mesh_d_FaceIndexMeshData as FaceIndexMeshData, mesh_d_FaceMeshData as FaceMeshData, mesh_d_TetraIndexMeshData as TetraIndexMeshData, mesh_d_TetraMeshData as TetraMeshData };
}
...
declare class PerspectiveCamera extends Object$1 implements PerspectiveCamera$1 {
    fov: number;
    near: number;
    far: number;
    alwaysUpdateCoord: boolean;
...
declare class OrthographicCamera extends Object$1 implements OrthographicCamera$1 {
    size: number;
    near: number;
    far: number;
    alwaysUpdateCoord: boolean;
...
type four_d_App = App;
declare const four_d_App: typeof App;
...
type four_d_ColorMixer = ColorMixer;
declare const four_d_ColorMixer: typeof ColorMixer;
...
type four_d_OrthographicCamera = OrthographicCamera;
declare const four_d_OrthographicCamera: typeof OrthographicCamera;
type four_d_PerspectiveCamera = PerspectiveCamera;
declare const four_d_PerspectiveCamera: typeof PerspectiveCamera;
...
declare namespace four_d {
  export { four_d_AmbientLight as AmbientLight, four_d_App as App, four_d_BasicMaterial as BasicMaterial, four_d_CWMeshGeometry as CWMeshGeometry, four_d_CheckerTexture as CheckerTexture, four_d_ColorMixer as ColorMixer, four_d_ColorUniformValue as ColorUniformValue, four_d_ConvexHullGeometry as ConvexHullGeometry, four_d_CubeGeometry as CubeGeometry, four_d_DirectionalLight as DirectionalLight, four_d_DitorusGeometry as DitorusGeometry, four_d_DuocylinderGeometry as DuocylinderGeometry, four_d_FloatUniformValue as FloatUniformValue, four_d_Geometry as Geometry, four_d_GlomeGeometry as GlomeGeometry, four_d_GridTexture as GridTexture, four_d_LambertMaterial as LambertMaterial, four_d_Light as Light, Material$1 as Material, four_d_MaterialNode as MaterialNode, four_d_Mesh as Mesh, four_d_NoiseTexture as NoiseTexture, four_d_NoiseWGSLHeader as NoiseWGSLHeader, Object$1 as Object, four_d_OrthographicCamera as OrthographicCamera, four_d_PerspectiveCamera as PerspectiveCamera, four_d_PhongMaterial as PhongMaterial, four_d_PointLight as PointLight, four_d_Renderer as Renderer, four_d_Scene as Scene, four_d_SimpleSkyBox as SimpleSkyBox, four_d_SkyBox as SkyBox, four_d_SpherinderSideGeometry as SpherinderSideGeometry, four_d_SpheritorusGeometry as SpheritorusGeometry, four_d_SpotLight as SpotLight, four_d_TesseractGeometry as TesseractGeometry, four_d_TigerGeometry as TigerGeometry, four_d_TorisphereGeometry as TorisphereGeometry, four_d_TransformUniformValue as TransformUniformValue, four_d_UVWVec4Input as UVWVec4Input, four_d_Vec4TransformNode as Vec4TransformNode, four_d_Vec4UniformValue as Vec4UniformValue, four_d_WgslTexture as WgslTexture, four_d_WireFrameConvexPolytope as WireFrameConvexPolytope, four_d_WireFrameScene as WireFrameScene, four_d_WireFrameTesseractoid as WireFrameTesseractoid, four_d_WorldCoordVec4Input as WorldCoordVec4Input };
  export type { four_d_Camera as Camera, four_d_Color as Color, four_d_ColorOutputNode as ColorOutputNode, four_d_Float as Float, four_d_FloatOutputNode as FloatOutputNode, four_d_RendererConfig as RendererConfig, four_d_TransformOutputNode as TransformOutputNode, four_d_Vec4OutputNode as Vec4OutputNode, four_d_WireFrameObject as WireFrameObject, four_d_WireFrameOccluder as WireFrameOccluder };
}

type RigidType = "still" | "passive" | "active";
...
import physics_d_force_accumulator = force_accumulator;
import physics_d_rigid = rigid;
declare namespace physics_d {
  export { physics_d_BoundingGlomeBroadPhase as BoundingGlomeBroadPhase, physics_d_BoundingGlomeTreeBroadPhase as BoundingGlomeTreeBroadPhase, physics_d_BroadPhase as BroadPhase, physics_d_Constrain as Constrain, physics_d_Damping as Damping, physics_d_Engine as Engine, physics_d_Force as Force, physics_d_ForceAccumulator as ForceAccumulator, physics_d_Gravity as Gravity, physics_d_IgnoreAllBroadPhase as IgnoreAllBroadPhase, physics_d_IterativeImpulseSolver as IterativeImpulseSolver, physics_d_Material as Material, physics_d_MaxWell as MaxWell, physics_d_PointConstrain as PointConstrain, physics_d_Rigid as Rigid, physics_d_RigidGeometry as RigidGeometry, physics_d_Solver as Solver, physics_d_Spring as Spring, physics_d_TorqueSpring as TorqueSpring, physics_d_World as World, physics_d_force_accumulator as force_accumulator, physics_d_rigid as rigid };
  export type { physics_d_CurrentCircuit as CurrentCircuit, physics_d_CurrentElement as CurrentElement, physics_d_ElectricCharge as ElectricCharge, physics_d_ElectricDipole as ElectricDipole, physics_d_ForceAccumulatorConstructor as ForceAccumulatorConstructor, physics_d_MagneticDipole as MagneticDipole, physics_d_PreparedCollision as PreparedCollision, physics_d_SolverConstructor as SolverConstructor };
}
...
declare const render_d_WgslReflect: typeof WgslReflect;
declare const render_d_createVoxelBuffer: typeof createVoxelBuffer;
declare namespace render_d {
  export { render_d_DefaultDisplayConfig as DefaultDisplayConfig, render_d_EyeStereo as EyeStereo, render_d_GPU as GPU, render_d_RaytracingPipeline as RaytracingPipeline, render_d_RetinaSliceFacing as RetinaSliceFacing, render_d_SliceRenderer as SliceRenderer, render_d_TetraSlicePipeline as TetraSlicePipeline, render_d_WgslReflect as WgslReflect, render_d_createVoxelBuffer as createVoxelBuffer };
