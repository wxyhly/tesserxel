...
(function (backrooms) {
    ...
    async function load() {
        ...
        const materials = {
            ...
            ceil: new four.LambertMaterial(new four.GridTexture([0.2, 0.2, 0.16, 0.6], [0.9, 0.8, 0.7, 0.3], 0.1, new four.Vec4TransformNode(new four.WorldCoordVec4Input, new math.Obj4(new math.Vec4(0, 0, 0, 0.5), new math.Bivec(0, 0, 0, 0, math._90).exp(), new math.Vec4(2, 1, 2, 2)))))
        };
...
export { backrooms };
//# sourceMappingURL=backrooms.js.map
