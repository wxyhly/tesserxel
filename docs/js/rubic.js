            ...
            for (let y = 0; y < order; y++) {
                ...
                for (let z = 0; z < order; z++) {
                    ...
                    for (let w = 0; w < order; w++) {
                        ...
                        let cube = mesh.tetra.tesseract().applyObj4(new math.Obj4(pos, null, new math.Vec4(1 - cellGap, 1 - cellGap, 1 - cellGap, 1 - cellGap)));
                        let delnums = [];
                        if (x !== 0)
                        ...
                        let hollow = hollow_explode_blc.clone().applyObj4(new math.Obj4(pos //, null, new math.Vec4(1 - hollowGap, 1 - hollowGap, 1 - hollowGap, 1 - hollowGap
